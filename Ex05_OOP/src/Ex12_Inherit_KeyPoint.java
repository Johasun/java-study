...
//	void KttvBuy(KtTv n) { // 구매자가 어떤 물건을 사는지 정보를 알아야 ( 그 물건의 가격정보 얻어올 수 있다)
...
//	}
//	
//	void AudioBuy(Audio n) { // 구매자가 어떤 물건을 사는지 정보를 알아야 ( 그 물건의 가격정보 얻어올 수 있다)
//		if(this.money < n.price) {
//			System.out.println("고객님 잔액이 부족합니다 ^^!"+this.money);
//			return; // 함수의 종료 ^^(구매행위 종료)
//		}
...
//	}
//	
//	void NoteBookBuy(NoteBook n) { // 구매자가 어떤 물건을 사는지 정보를 알아야 ( 그 물건의 가격정보 얻어올 수 있다)
//		if(this.money < n.price) {
//			System.out.println("고객님 잔액이 부족합니다 ^^!"+this.money);
//			return; // 함수의 종료 ^^(구매행위 종료)
//		}
...
//	}
	...
	//2차 개선 : 하나의 여러가지 기능(overloading)
	//반복되는 코드를 .... 모든 제품의 Product 상속 ... 모든 제품의 부모 Product
	//다형성
	//Product p;
	//KtTv t = new KtTv();
	//p = t;
	
	void Buy(Product n) { // 구매자가 어떤 물건을 사는지 정보를 알아야 ( 그 물건의 가격정보 얻어올 수 있다)
		if(this.money < n.price) {
			System.out.println("고객님 잔액이 부족합니다 ^^!"+this.money);
			return; // 함수의 종료 ^^(구매행위 종료)
		}
